...
public static void main(String[] args) {
    ...
    public static void updateStudent(ArrayList<Student> list) {
        ...
        if(index == -1){
            ...
            System.out.print("Please enter a new student name:");
            String name = sc.next();
            System.out.print("Please enter the new student age:");
            int age = sc.nextInt();
            System.out.print("Please enter a new student's birthday:");
