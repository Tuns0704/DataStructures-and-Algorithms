public class ArrayList<T> implements List<T>{
	...
	**/
	...
	/** @param int index
	*   @param T element
	*   Add the element at specified index, shift the elements if necessary
	...
	*/
	...
	//find the first occurences of element specified and return its index otherwise return DEFAULT_ERROR_CODE;
